...
def generate() -> str:
    ...
    sections = [
        ...
        "\n".join(_model_section(model.__name__, model) for model in (
            SessionListCommand, SessionListResult, SessionRenameCommand, SessionConfigureCommand,
            SessionUpdateResult, SessionDeleteCommand, SessionDeleteResult,
            SessionCancelCommand, SessionCancelResult, ConfigModelsCommand, ConfigModelsResult,
            ...
            WorkspaceGitDiffResult, WorkspacePullRequestsResult, WorkspaceRemoveResult,
            SchedulesListCommand, ScheduleCreateCommand, ScheduleUpdateCommand,
            ScheduleDeleteCommand, ScheduleRunNowCommand,
            SchedulesListResult, ScheduleResult, ScheduleDeleteResult,
        )),
        "\n## Server Push\n\n",
        ...
        _model_section("WorkspaceChangedEvent", WorkspaceChangedEvent),
        _model_section("WorkspaceProjectsChangedEvent", WorkspaceProjectsChangedEvent),
